    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-md">
          ...
          <h2 className="sm:text-3xl lg:text-6xl text-center mb-3 text-green-600">
            GIVE A HAND
          </h2>
          ...
          <p className="mb-5">
            That don't lights. Blessed land spirit creature divide our made two
            itself upon you'll dominion waters.
          </p>
          <div className="mt-7 text-center">
            <button className="btn btn-outline btn-warning mr-6">
              Donate Now
            </button>
            <button className="btn btn-outline btn-warning">See Causes</button>
          </div>
